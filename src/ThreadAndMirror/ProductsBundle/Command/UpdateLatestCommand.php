...
class UpdateLatestCommand extends ContainerAwareCommand
{
    protected function configure()
    {
        $this
            ->setName('products:updateLatest')
            ->setDescription('Performs a crawl of a given shop to find newly added products.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        // get the products
        $existing = $em->getRepository('ThreadAndMirrorProductsBundle:Shop')->getLatestProductIds($input->getArgument('id'));
        ...
        $results = $parser->latest($existing);
